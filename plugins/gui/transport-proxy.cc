...
namespace clap {
   ...
   void TransportProxy::update(const clap_event_transport &t) {
      ...
      update<bool>(
         _isPlaying, t.flags & CLAP_TRANSPORT_IS_PLAYING, &TransportProxy::isPlayingChanged);
      update<bool>(
         _isRecording, t.flags & CLAP_TRANSPORT_IS_RECORDING, &TransportProxy::isRecordingChanged);
      update<bool>(_isLoopActive,
                   t.flags & CLAP_TRANSPORT_IS_LOOP_ACTIVE,
      ...
      update<int>(
         _timeSignatureNumerator, t.tsig_num, &TransportProxy::timeSignatureNumeratorChanged);
      update<int>(
   ...
   void TransportProxy::setIsSubscribed(bool value) {
      ...
      _isSubscribed = value;
      isSubscribedChanged();
      _client.guiListener().onGuiSetTransportIsSubscribed(value);
   }
} // namespace clap